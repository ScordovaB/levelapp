...
class _TeamProfileWidgetState extends State<TeamProfileWidget> {
  ...
  Team team = Team(
      ...
      name: 'Loading',
      sport: 'Loading',
      background: "https://i.gifer.com/ZKZg.gif",
      profile: "https://i.gifer.com/ZKZg.gif",
      description: "",
      nextMatches: []);
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  if (user.teams.contains(widget.id)) {
                                    removeTeamFromUser(user.userId, widget.id)
                                        .then((value) {
                                      setState(() {
                                    ...
                                    addTeamToUser(user.userId, widget.id)
                                        .then((value) {
                                      setState(() {
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      if (players.isEmpty) Text('Loading...')
                    ],
                  ),
                ),
                Container(
